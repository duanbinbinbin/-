     ...
     <div class="header_top">
		  <div class="col-sm-9 h_menu4">
				<ul class="megamenu skyblue">
				      ...
				      <li class="active grid"><a class="color1" href="TypeServlet?type=主菜">主菜</a><div class="megapanel">
						<div class="row">
							<div class="col1">
								<div class="h_nav">
									<ul>
        ...
        <!--内容-->
                <div class="row">
                	<c:forEach items="${goodslist}" var="list">
	                    <div class="col-md-4">
	                            <div class="col_1_of_single1 span_1_of_single1" style="width: auto;height: auto;">
	                                <a href="ProductdetailServlet?id=${list.id }">
	                                    <img src="images/updFile/${list.imgUrl }" class="img-responsive" alt="${list.name }图片"/>
	                                    <h3>${list.name }</h3>
	                                    <p>
	                                    	<c:choose>
							                	<c:when test="${user==null}">
							                		<a onclick="alert('请登录后购买!')">加入购物车</a>
							                	</c:when>
							                	<c:otherwise>
							                		<a href="AddShoppingCarServlet?id=${list.id }">加入购物车</a>
							                	</c:otherwise>
							                </c:choose>
	                                    	&nbsp;&nbsp;&nbsp;已有${list.evaluate }人评论
	                                    </p>
	                                    <h4>${list.price }元</h4>
	                                </a>
	                            </div>
                ...
                <ul class="pagination pull-right">
			       	<c:choose>
			       		<c:when test="${cutpage>1}">
					    	<li><a href="TypeServlet?pages=${cutpage-1 }&type=主菜">&laquo;</a></li>
						</c:when>
						<c:otherwise>
					  ...
					  <c:forEach begin="1" end="${maxpages}" var="i">
					  	<c:choose>
					  		<c:when test="${cutpage==i}">			  		
					  			<li class="active"><a href="TypeServlet?pages=${i}&type=主菜" class="active">${i}</a></li>
					  		</c:when>
					  		<c:otherwise>
					  			<li ><a href="TypeServlet?pages=${i}&type=主菜" >${i}</a></li>
					  		</c:otherwise>
					  	</c:choose>
					  </c:forEach>
					  ...
					  <c:choose>
			       	  	<c:when test="${cutpage<maxpages}">
					  		<li><a href="TypeServlet?pages=${cutpage+1 }&type=主菜">&raquo;</a></li>
					  	</c:when>
						<c:otherwise>
