    ...
    <div class="mybody container" id="updgoodscon">
        <div class="row">
            ...
            <div class="content col-md-5 col-sm-5">
                ...
                <form action="AdminsUpdateGoodsServlet" method="post" >
                	<input name="id" type="hidden" value="${g.id }"/>
                    <table class="table table-bordered table-hover" align="center">
                    	<tr align="center" style="background-color:#e0dde1">
                        	<td colspan="2"><h3>商品修改</h3></td>
                        </tr>
                        <tr>
                        	<th>商品名</th>
                        	<td>
                        		<input name="name" type="text" value="${g.name }"/>
                        	</td>
                        </tr>
                        <tr>
                        	<th>商品类型</th>
                        ...
                        <tr>
                        	...
                        	<td>
								<select name="tasteType"> 
									<option value="${g.tasteType }">${g.tasteType }</option> 
                        ...
                        <tr>
                        	...
                        	<td>
								<select name="healthType"> 
									<option value="${g.healthType }">${g.healthType }</option> 
                        ...
                        <tr>
                        	...
                        	<td>
								<select name="manufacturer"> 
									<option value="${g.manufacturer }">${g.manufacturer }</option> 
                        ...
                        <tr>
                        	<th>库存</th>
                        	<td><input name="num" type="text" value="${g.num }"/></td>
                        </tr>
                        <tr>
                        	<th>商品折扣</th>
                        	<td>
                        ...
                        <tr>
                        	<th>商品介绍</th>
                        	<td><textarea cols="22" rows="3" name="introduce">${g.introduce }</textarea></td>
                        </tr>
                        <tr align="center">
                        	<td colspan="2">
