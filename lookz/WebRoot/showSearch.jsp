     ...
     <div class="header_top">
		  <div class="col-sm-9 h_menu4">
				<ul class="megamenu skyblue">
				      ...
				      <li class="grid"><a class="color1" href="TypeServlet?type=主菜">主菜</a><div class="megapanel">
						<div class="row">
							<div class="col1">
								<div class="h_nav">
									<ul>
	                    ...
	                    <div class="col-md-4">
	                            <div class="col_1_of_single1 span_1_of_single1" style="width: auto;height: auto;">
	                                <a href="single.html">
	                                    ...
	                                    <h3>${list.name }</h3>
	                                    <p>加入购物车&nbsp;&nbsp;&nbsp;已有${list.evaluate }人评论</p>
	                                    <h4>${list.price }元</h4>
	                                </a>
	                            </div>
	                    </div>
