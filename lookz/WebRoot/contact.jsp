...
<div class="content">
  <div class="content_box">
	<div class="men">
	 <h1 class="contact_head">我们的地址</h1>
	 <div class="contact_box">
	  <div class="col-sm-4">
	  	 <address class="addr">
              ...
              <dl>
                <dt>超经理:</dt>
                <dd>+1 800 551 6580</dd>
              </dl>
              <dl>
                <dt>固定电话:</dt>
                <dd>+1 800 602 6035</dd>
              </dl>
              <dl>
                <dt>传真:</dt>
                <dd>+1 800 883 9898</dd>
              </dl>
              <p>邮箱:
                <a href="#"> mail@shanghaidemolink.org</a>
              </p>
            </address>
	     </div>
	     <div class="col-sm-4">
	  	 <address class="addr">
              ...
              <dl>
                <dt>赵经理:</dt>
                <dd>+1 800 554 6580</dd>
              </dl>
              <dl>
                <dt>固定电话:</dt>
                <dd>+1 800 605 6035</dd>
              </dl>
              <dl>
                <dt>传真:</dt>
                <dd>+1 800 886 9898</dd>
              </dl>
              <p>邮箱:
                <a href="#"> mail@beijingdemolink.org</a>
              </p>
            </address>
	     </div>
	     <div class="col-sm-4">
	  	 <address class="addr">
              ...
              <dl>
                <dt>李经理:</dt>
                <dd>+1 800 557 6580</dd>
              </dl>
              <dl>
                <dt>固定电话:</dt>
                <dd>+1 800 608 6035</dd>
              </dl>
              <dl>
                <dt>传真:</dt>
              ...
              <p>邮箱:
                <a href="#"> mail@shenzhendemolink.org</a>
              </p>
            </address>
	     </div>
	     <div class="clearfix"> </div>
	   	  ...
	   	  <h2>欢迎留言</h2>
	           <form action="MessageServlet" method="post" >
					<div class="row_5">
					 	...
					 	<input name="phone" type="text" placeholder="Phone" style="margin-left:20px"/>
					 	<div class="clearfix"></div>
					</div>
					<div class="row_6">
	                ...
	                <c:choose>
	                	<c:when test="${user==null}">
	                		<input onclick="alert('请登录!')" name="submit" type="submit" id="submit" value="提交">
	                	</c:when>
	                	<c:otherwise>
